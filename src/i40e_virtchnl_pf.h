...
int i40e_set_ingress_mirror(struct net_device *netdev, int vf_id,const int mirror);
int i40e_set_pf_ingress_mirror(struct net_device *netdev, const int mirror);
int i40e_set_both_mirror(struct net_device *netdev, int vf_id,const int mirror);
int i40e_rem_mirror(struct net_device *netdev, int vf_id,const int mirror);
